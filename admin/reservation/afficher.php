...
<head>
    ...
    <title>Afficher-Réservation</title>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $res->nb_tables ?></td>
                                    <td>
                                        <a href="Editer.php?pdt=<?= $res->id ?>" class="btn btn-success">Modifier</a>
                                        <a href="Supprimer.php?pdt=<?= $res->id ?>" class="btn btn-danger">Supprimer</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
