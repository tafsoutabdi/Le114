    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" ">
        ...
        <div class="navbar-collapse d-lg-flex align-items-lg-center">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="ajouter.php" style="font-weight: bold;">Nouveau</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="afficher.php" style="font-weight: bold;">Plats</a>
                </li>
            </ul>
        </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"> <?= $plats->id ?> </th>
                                    <td>
                                        <img src="../../uploads<?= $plats->image ?>" style="width: 50px">

                                    </td>
                                    <td> <?= $plats->nom ?> </td>
                                    <td> <?= $plats->prix ?> DA</td>
                                    <td> <?= substr($plats->description, 0,100); ?></td>
                                    <td>
                                        <a href=" Editer.php?pdt=<?= $plats->id ?>" class="btn btn-success">Modifier</a>
                                        <a href="Supprimer.php?pdt=<?= $plats->id ?>"
