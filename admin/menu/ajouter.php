...
{
  if(isset($_FILES['image']) && isset($_POST['nom']) && isset($_POST['prix']) && isset($_POST['description']))
  {
    if(!empty($_FILES['image']['tmp_name']) && !empty($_POST['nom']) && !empty($_POST['prix']) && !empty($_POST['description']))
    {
      ...
      try 
      {
        ajouter_plats($destination, $nom, $prix, $description);       
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">L'image du plat</label>
