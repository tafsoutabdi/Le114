        ...
        <div class="container-fluid">
            ...
            <!-- <div class="navbar-collapse d-lg-flex align-items-lg-center">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="afficher.php" style="font-weight: bold;">Clients</a>
                    </li>
                </ul>
            </div> -->
        </div>
                ...
                <table class="table  w-50">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <img src="../../uploads<?= $user->image ?>" style="width: 50px"> -->
                                <?php
if (isset($fetch) && $fetch['image'] != '') {
    echo '<img src="../../uploads' . $fetch['image'] . '" style="width: 50px">';
} else {
    echo '<img src="../../images/default-avatar.png"style="width: 50px">';
}
?>
                            ...
                            <td>
                                <a href="Supprimer.php?pdt=<?= $user->id ?>" class="btn btn-danger">Supprimer</a>
